...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { latitude: @stop.latitude, longitude: @stop.longitude, stopcode: @stop.stopcode, stopid: @stop.stopid, stopname: @stop.stopname }
    end
  ...
  test "should update stop" do
    put :update, id: @stop, stop: { latitude: @stop.latitude, longitude: @stop.longitude, stopcode: @stop.stopcode, stopid: @stop.stopid, stopname: @stop.stopname }
    assert_redirected_to stop_path(assigns(:stop))
  end
